...
{
    public Interval[] inputIntervals;
    public int intersectionCounter;
    public int maximumIntersectionCount;
    public int maximumIntervalStart = 0;
    public int maximumIntervalEnd = 0;
    public bool onMaximumInterval = false;
    public List<Interval> maximumIntervals = new List<Interval>();
}
...
public static class IntervalIntersectionSolver
{
    ...
    internal static IntervalEndPoint[] SortAndFlattenIntervals(Interval[] intervals)
    {
